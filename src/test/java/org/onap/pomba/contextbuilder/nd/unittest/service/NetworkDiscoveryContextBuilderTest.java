...
package org.onap.pomba.contextbuilder.nd.unittest.service;
...
import org.onap.pomba.contextbuilder.nd.service.rs.RestService;
...
public class NetworkDiscoveryContextBuilderTest {
    ...
    public void testVerifyNoAuthoriztion() throws Exception {
        Response response = this
                            .restService
                            .getContext(httpServletRequest, null, partnerName, transactionId, serviceInstanceId, null, null);
    ...
    public void testVerifyBadAuthoriztion() throws Exception {
        ...
        Response response = this
                            .restService
                            .getContext(httpServletRequest, authorization, partnerName, transactionId, serviceInstanceId, null, null);
    ...
    public void testVerifyPartnerName() throws Exception {
        Response response = this
                            .restService
                            .getContext(httpServletRequest, authorization, null, transactionId, serviceInstanceId, null, null);
    ...
    public void testServiceInstanceId() throws Exception {
        Response response = this.restService.getContext(httpServletRequest, authorization, partnerName, transactionId, null, null, null);
