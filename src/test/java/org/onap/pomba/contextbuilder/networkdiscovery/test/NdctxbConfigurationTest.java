...
public class NdctxbConfigurationTest {
    ...
    public void testGetUrl() {
        ...
        assertEquals("www.google.com", configuration.getURL().toString());
    }
    ...
    public void testGetNdBasicAuth() {
        ...
        assertEquals("Basic YWRtaW46YWRtaW4=", configuration.getNdBasicAuth().toString());
    }
    ...
    public void testGetSdBasicAuth() {
        ...
        assertEquals("Basic YWRtaW46YWRtaW4=", configuration.getSdBasicAuth().toString());
    }
