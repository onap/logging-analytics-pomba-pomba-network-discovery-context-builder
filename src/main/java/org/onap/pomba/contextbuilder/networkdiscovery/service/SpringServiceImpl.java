...
public class SpringServiceImpl implements SpringService {
    ...
    public ModelContext getContext(HttpServletRequest req,
        ...
        try {
            ...
            List <String> sentRequestIdList = sendNetworkDiscoveryRequest(serviceDecompCtx, serviceInstanceId, partnerName, authorization , latchSignal); 
  ...
  public void networkDiscoveryNotification(NetworkDiscoveryNotification ndNotification, String authorization) throws DiscoveryException {				
  		...
  		try {
			myNetworkDiscoveryRspInfo = networkDiscoveryInfoList.get(requestId);
	  		if (myNetworkDiscoveryRspInfo == null) {
	  			...
	  			log.error("invalide RequestId:"+requestId);
	  			return;
	  		}
  		} finally {
  			lock.unlock();
    ...
    private List <String> sendNetworkDiscoveryRequest (ModelContext serviceDecompCtx, String serviceInstanceId , String partner_name, String authorization,
	     ...
	     for (VF entryVF: vfList){
	     	...
	     	for (VNFC entryVnfc : vnfcList){
	     		...
	     		if ( true == sendNetworkDiscoveryRequestToSpecificServer(partner_name, authorization,parent_requestId, requestId, vserverId, RESOURCE_TYPE_VSERVER, latchSignal)) {
    ...
    private boolean sendNetworkDiscoveryRequestToSpecificServer (String partner_name, String authorization, String parent_requestId, String requestId,String vserverId,String resourceType,
    		  CountDownLatch latchSignal) throws DiscoveryException{
    	log.info("Sending message to networkDiscoveryMicroService with serverId:"+ vserverId + " and type:" + resourceType );
