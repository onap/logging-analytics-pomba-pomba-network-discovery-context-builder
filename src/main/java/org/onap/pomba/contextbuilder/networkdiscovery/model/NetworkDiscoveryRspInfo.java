...
public class NetworkDiscoveryRspInfo {
	...
	private String resourceId;     //e.g.: vserver
	private String resourceType;  // e.g.: vserverId
	...
	public String toString() {
		return "networkDiscoveryRspInfo [requestId=" + this.requestId + ", resourceId=" + this.resourceId+ ", resourceType=" + this.resourceType + "]";
	}
}
