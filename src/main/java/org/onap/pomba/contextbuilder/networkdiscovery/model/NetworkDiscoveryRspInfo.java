...
public class NetworkDiscoveryRspInfo {
    ...
    private List<NetworkDiscoveryNotification> networkDiscoveryNotificationList = Collections.synchronizedList(new ArrayList<>());
    ...
    public String toString() {
        return "networkDiscoveryRspInfo [requestId=" + this.requestId + ", vServerId=" + this.serverId + "]";
    }
}
