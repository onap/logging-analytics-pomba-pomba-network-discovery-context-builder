...
public interface RestService {
 ...
 @Path("/context")
 @Produces(MediaType.APPLICATION_JSON)
 @ApiOperation(value = "Fetch network info for service", notes = "Returns a JSON object which represents the Context model data", response = GenericResponse.class)
 ...
 public Response getContext(@Context HttpServletRequest req, @HeaderParam("Authorization") String authorization,
   ...
   @QueryParam("serviceInstanceId") String serviceInstanceId, @QueryParam("modelVersionId") String modelVersionId,
